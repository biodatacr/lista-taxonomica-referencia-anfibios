...
FILE_CHECKLIST <- "data/processed/lista-taxonomica-referencia-anfibios.csv"
...
FILE_INTERIM_CHECKLIST <- "data/interim/anfibios_2022.csv"

# GBIF QUERY of occurrences of species in checklist
GBIF_QUERY_OCCURRENCES_CHECKLIST <- "https://doi.org/10.15468/dl.rn97yg"

# GBIF QUERY of occurrences in higherrank
GBIF_QUERY_OCCURRENCES_HIGHERRANK <- "https://doi.org/10.15468/dl.wndm84"

# File with GBIF occurrences of species in checklist
FILE_OCCURRENCES_CHECKLIST <- "data/processed/registros-presencia-lista-taxonomica-referencia-anfibios-gbif.csv"

# File with GBIF occurrences in higher rank (e.g. class, order)
FILE_OCCURRENCES_HIGHERRANK <- "data/processed/registros-presencia-anfibios-gbif.csv"

# Number of records in the raw (initial) checklist
N_RAW_CHECKLIST <- 216

# Vernacular name of higher taxonomic group
HIGHERTAXONOMICGROUP_VERNACULAR <- "anfibios"

# Scientific name of higher taxonomic group
HIGHERTAXONOMICGROUP_SCIENTIFIC <- "Amphibia"

# Species name example
SPECIES_NAME_EXAMPLE <- "Oophaga pumilio"
```
...
El siguiente mapa muestra la distribución geográfica de los registros de presencia de las `r n_checklist` especies de la lista de referencia. Se incluyó una capa para cada uno de los órdenes taxonómicos, las cuales pueden activarse y desactivarse con el control de capas. Al hacer clic sobre cada punto, pueden observarse algunos elementos de datos del registro de presencia correspondiente.
